...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "pruebaGet@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "pruebaGet API";

        private String description = "pruebaGet API documentation";
    ...
    public static class Metrics {
        ...
        public static class Graphite {
            ...
            private String prefix = "pruebaGet";
